...
class Aepro{
    ...
    function _editor_enqueue_scripts(){
        ...
        wp_enqueue_script('ae-swiper',AE_PRO_URL.'includes/assets/lib/swiper/js/swiper'. AE_PRO_SCRIPT_SUFFIX .'.js',array('jquery'),'4.3.2',true);
        ...
        wp_enqueue_script('ae-masonry',AE_PRO_URL.'includes/assets/lib/masonry/js/masonry.pkgd'. AE_PRO_SCRIPT_SUFFIX .'.js',array('jquery'),'2.0.1', true);
   ...
   public function set_custom_edit_ae_global_templates_posts_columns($columns) {
    ...
    public function _enqueue_scripts(){
        ...
        wp_register_script('ae-swiper',AE_PRO_URL.'includes/assets/lib/swiper/js/swiper'. AE_PRO_SCRIPT_SUFFIX .'.js',array('jquery'),'4.3.2',true);
        wp_enqueue_style('ae-swiper',AE_PRO_URL.'includes/assets/lib/swiper/css/swiper'. AE_PRO_SCRIPT_SUFFIX .'.css');
        ...
        wp_enqueue_script('ae-masonry',AE_PRO_URL.'includes/assets/lib/masonry/js/masonry.pkgd'. AE_PRO_SCRIPT_SUFFIX .'.js',array('jquery'),'2.0.1', true);
        wp_register_script('ae-infinite-scroll', AE_PRO_URL.'includes/assets/lib/infinite-scroll/infinite-scroll.pkgd'. AE_PRO_SCRIPT_SUFFIX.'.js', array('jquery'), '3.0.4', true);
