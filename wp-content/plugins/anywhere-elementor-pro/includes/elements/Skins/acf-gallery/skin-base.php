    ...
    public function common_style_control(){
        ...
        /*$this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ae-swiper-button-prev' => '-webkit-mask-size:{{SIZE}}px auto; mask-size:{{SIZE}}px auto;',
                    '{{WRAPPER}} .ae-swiper-button-next' => '-webkit-mask-size:{{SIZE}}px auto; mask-size:{{SIZE}}px auto;',
                ],
                'condition' =>
                    [
                        $this->get_control_id('navigation_button') => 'yes'
           ...
           // $this->parent->add_render_attribute('outer-wrapper', 'data-direction', $direction);
            ...
            if($this->get_instance_value('open_lightbox') != 'no') {
                $this->parent->add_render_attribute('link', [
                    ...
                    'data-elementor-lightbox-slideshow' => $this->parent->get_id(),
                ]);
