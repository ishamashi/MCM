...
class Aepro_Portfolio extends Aepro_Post_Blocks{
	...
	protected function _register_controls() {
		...
		*/
		...
		$this->start_controls_tabs('filter_styles');
		    ...
		    $this->start_controls_tab('filter_style_normal', [ 'label'	=>  __('Normal','wts_sa') ]);
            ...
            $this->start_controls_tab('filter_style_hover', [ 'label'	=>  __('Hover/Active','wts_sa') ]);
                        ...
                        <div class="aep-filter-bar">
                            ...
                            <?php
                                ...
                                if($settings['show_all'] == 'yes'){
                                    ?>
                                    <div class="filter-items <?php echo ((isset($_POST['term_id']) && $_POST['term_id'] == 0) || !count($_POST))?'active':''; ?>"><a  href="#" data-term-id="0"><?php echo __('All', 'ae-pro'); ?></a></div>
                                    <?php
                                }
	...
	function get_filters($settings){
        ...
        if(count($settings[$filter_taxonomy.'_ae_ids'])){
