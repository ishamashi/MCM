 ...
 * Toggle Widget
 */
class PP_Toggle_Widget extends Widget_Base {
    ...
    public function get_icon() {
        return 'eicon-dual-button power-pack-admin-icon';
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new PP_Toggle_Widget() );