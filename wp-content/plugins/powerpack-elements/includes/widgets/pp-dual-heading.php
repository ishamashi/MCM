 ...
 * Dual Heading Widget
 */
class PP_Dual_Heading_Widget extends Widget_Base {
    ...
    public function get_icon() {
        return 'fa fa-clone power-pack-admin-icon';
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new PP_Dual_Heading_Widget() );