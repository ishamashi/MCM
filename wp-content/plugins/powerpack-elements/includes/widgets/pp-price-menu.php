...
class PP_Price_Menu_Widget extends Widget_Base {
    ...
    public function get_icon() {
        return 'eicon-price-list power-pack-admin-icon';
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new PP_Price_Menu_Widget() );