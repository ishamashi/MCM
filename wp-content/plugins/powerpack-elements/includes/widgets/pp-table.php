...
class PP_Table_Widget extends Widget_Base {
    ...
    public function get_icon() {
        return 'eicon-table power-pack-admin-icon';
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new PP_Table_Widget() );