 ...
 * Info List Widget
 */
class PP_Info_List_Widget extends Widget_Base {
    ...
    public function get_icon() {
        return 'eicon-bullet-list power-pack-admin-icon';
    }
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'info-list', 'class', 'pp-list-items' );
        ...
        if ( $settings['icon_position'] == 'right' ) {
            $this->add_render_attribute( 'info-list', 'class', 'icon-right' );
            ...
            $this->add_render_attribute( 'info-list', 'class', 'icon-top' );
            ...
            $this->add_render_attribute( 'info-list', 'class', 'icon-left' );
        ...
        <div class="pp-info-list-container pp-list-container">
            <ul <?php echo $this->get_render_attribute_string( 'info-list' ); ?>>
...
Plugin::instance()->widgets_manager->register_widget_type( new PP_Info_List_Widget() );