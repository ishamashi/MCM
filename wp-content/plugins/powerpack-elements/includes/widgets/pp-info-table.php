 ...
 * Info Table Widget
 */
class PP_Info_Table_Widget extends Widget_Base {
	...
	public function get_icon() {
		return 'fa fa-credit-card-alt power-pack-admin-icon';
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new PP_Info_Table_Widget() );
