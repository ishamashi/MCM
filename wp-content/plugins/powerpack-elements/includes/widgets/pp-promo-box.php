 ...
 * Promo Box Widget
 */
class PP_Promo_Box_Widget extends Widget_Base {
    ...
    public function get_icon() {
        return 'fa fa-volume-up power-pack-admin-icon';
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new PP_Promo_Box_Widget() );