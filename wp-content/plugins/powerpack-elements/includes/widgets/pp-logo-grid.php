 ...
 * Logo Grid Widget
 */
class PP_Logo_Grid_Widget extends Widget_Base {
    ...
    public function get_icon() {
        return 'eicon-apps power-pack-admin-icon';
    }
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'logo-grid', 'class', 'pp-logo-grid clearfix' );
...
Plugin::instance()->widgets_manager->register_widget_type( new PP_Logo_Grid_Widget() );