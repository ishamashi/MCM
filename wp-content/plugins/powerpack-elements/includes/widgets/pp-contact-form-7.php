 ...
 */
class PP_Contact_Form_Widget extends Widget_Base {
    ...
    public function get_icon() {
        return 'fa fa-envelope-o power-pack-admin-icon';
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new PP_Contact_Form_Widget() );