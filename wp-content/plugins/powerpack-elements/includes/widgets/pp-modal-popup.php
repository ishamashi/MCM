 ...
 * Popup Box Widget
 */
class PP_Modal_Popup_Widget extends Widget_Base {
		...
		$this->add_control(
			...
			[
				...
				'options'               => [
					...
					'page-load'    => __( 'Page Load', 'power-pack' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new PP_Modal_Popup_Widget() );