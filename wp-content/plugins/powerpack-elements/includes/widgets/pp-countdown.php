 ...
 * Countdown Widget
 */
class PP_Countdown_Widget extends Widget_Base {
	...
	public function get_title() {
		return __( 'Countdown', 'power-pack' );
	}
	...
	public function get_icon() {
		return 'eicon-countdown power-pack-admin-icon';
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new PP_Countdown_Widget() );