 ...
 */
class PP_One_Page_Navigation_Widget extends Widget_Base {
    ...
    public function get_icon() {
        return 'eicon-navigation-vertical power-pack-admin-icon';
    }
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'onepage-nav', 'class', 'pp-one-page-nav' );
        
        $this->add_render_attribute( 'onepage-nav', 'id', 'pp-one-page-nav-'.$this->get_id() );
        
        $this->add_render_attribute( 'onepage-nav', 'data-section-id', 'pp-one-page-nav-'.$this->get_id() );
...
Plugin::instance()->widgets_manager->register_widget_type( new PP_One_Page_Navigation_Widget() );