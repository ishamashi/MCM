 ...
 * Link Effects Widget
 */
class PA_Link_Effects_Widget extends Widget_Base {
    ...
    public function get_icon() {
        return 'fa fa-link power-pack-admin-icon';
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new PA_Link_Effects_Widget() );