...
class PP_Advanced_Menu_Widget extends Widget_Base {
	...
	public function get_icon() {
		return 'eicon-nav-menu power-pack-admin-icon';
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new PP_Advanced_Menu_Widget() );
