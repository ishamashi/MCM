...
if ( !function_exists('pp_get_page_templates') ) {
    function pp_get_page_templates(){
...
function pp_get_modules()
{
    $modules = array(
        ...
        'pp-button'                 => __('Button', 'powerpack'),
        'pp-divider'                => __('Divider', 'powerpack'),
        'pp-testimonial'            => __('Testimonial', 'powerpack'),
        'pp-testimonials-slider'    => __('Testimonial Slider', 'powerpack'),
        'pp-recipe'                 => __('Recipe', 'powerpack'),
        'pp-quote'                  => __('Quote', 'powerpack'),
...
{
    $enabled_modules = PP_Admin_Settings::get_option( 'pp_elementor_modules', true );
