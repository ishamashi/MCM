...
class Widget_Eael_Pricing_Table extends Widget_Base {
   ...
   public function get_categories() {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			'eael_pricing_table_icon_margin',
			[
				'label' => esc_html__( 'Icon Margin', 'essential-addons-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
	 					'{{WRAPPER}} .eael-pricing-item .price-tag:before' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	 			],
			]
		);
