...
class Widget_Eael_Testimonial extends Widget_Base {
   ...
   public function get_categories() {
	...
	protected function render( ) {
	  ...
	  $testimonial_classes = $this->get_settings('eael_testimonial_image_rounded') . " " . $this->get_settings('eael_testimonial_alignment') . " " . $this->get_settings('eael_testimonial_rating_number');
...
<div id="eael-testimonial-<?php echo esc_attr($this->get_id()); ?>" class="eael-testimonial-item clearfix <?php echo $testimonial_classes; ?>">
	...
	<div class="eael-testimonial-content">
		...
		<?php if ( ! empty( $settings['eael_testimonial_enable_rating'] ) ) : ?>
